...
def main():
    ...
    try:
        ...
        print()
        print("Two reasons this happens:")
        print()
        print("1. That stage has not unlocked yet. Stages open two per day -")
        print("   check the help channel for today's unlock and the download link.")
        print()
        print("2. You are on a branch other than main. Run 'git checkout main'")
        print("   first - the quest files only live on main.")
        return 1
